...
- **Keyboard:** 1–4 select answers, Enter or Right Arrow advances, Left Arrow returns, and Space skips. Shortcuts are suppressed while editing and when a focused button should handle its own activation.
