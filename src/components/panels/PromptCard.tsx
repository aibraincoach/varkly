...
const PromptCard: React.FC<PromptCardProps> = ({
  ...
  return (
    <div className="border-[1.5px] border-line rounded-xl bg-surface flex flex-col min-h-0 overflow-hidden">
      <div className="flex items-center justify-between px-3.5 py-2.5 border-b border-line-2">
