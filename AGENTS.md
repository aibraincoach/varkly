...
- Keyboard ownership: window listeners track owned keys from shortcut `keydown` through matching `keyup`, `blur`, or unmount; question shortcuts win over focused controls; landing/results/prompts preserve native button/link activation.
